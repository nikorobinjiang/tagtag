...
export function fetchList(query) {
  return request({
    url: VueStore.getters.zonePrefix + '/material/material_report',
    method: 'GET',
    params: query
  })
}
...
export function ItemDetail(id) {
  return request({
    url: VueStore.getters.zonePrefix + '/material/material_report/' + id +'/show',
    method: 'GET',
    data: {
...
export function ItemToutiaoDetail(id) {
    return request({
      url: VueStore.getters.zonePrefix + '/material/material_report_detail_toutiao?ad_id=' + id,
      method: 'GET',
      data: {
        data: form
      }
